...
class Program
{
    static void Main()
    {
        ...
        // Deserialize JSON strings into JObject
        ...
        string htmlTable = GenerateHtmlTable(obj1, obj2);
    ...
    static string GenerateHtmlTable(JObject obj1, JObject obj2)
    {
        ...
        CompareProperties(obj1, obj2, "", html);
    ...
    static void CompareProperties(JToken token1, JToken token2, string path, StringBuilder html)
    {
        ...
        switch (token1.Type)
        {
            case JTokenType.Object:
                ...
                foreach (var property in obj1.Properties())
                {
                    ...
                    {
                        CompareProperties(property.Value, value2, propertyPath, html);
                    }
                    else
                    {
            ...
            case JTokenType.Array:
                ...
                for (int i = 0; i < Math.Max(array1.Count, array2.Count); i++)
                {
                    ...
                    {
                        CompareProperties(array1[i], array2[i], elementPath, html);
                    }
